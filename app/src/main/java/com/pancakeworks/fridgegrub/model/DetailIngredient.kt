 ...
 *   category-expanded matched set [com.pancakeworks.fridgegrub.data.NewIngredientIndex.matching]
 *   produces for the card's ratio (see [com.pancakeworks.fridgegrub.viewmodel.RecipeViewModel]),
 ...
 *   the checkmark live from [canonical] via plain [com.pancakeworks.fridgegrub.data.IngredientMatcher.matches],
